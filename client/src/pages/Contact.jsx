              ...
              {[
                ...
                >
                  <div className="relative w-full">
                    <div
                      className={`w-full ${slot.height} bg-indigo-100 rounded-t-lg group-hover:bg-indigo-500 transition-colors duration-300 relative`}
                    >
                  ...
                  <div className="text-center text-xs md:text-sm text-gray-500 mt-2 font-medium">
                    {slot.time}
                  </div>
                </div>
              ))}
